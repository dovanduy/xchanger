...
import static com.example.erikiado.myapplication.backend.RetroAdapter.createService;
...
@Api(
        ...
        namespace = @ApiNamespace(
                ownerDomain = "backend.myapplication.erikiado.example.com",
                ownerName = "backend.myapplication.erikiado.example.com",
                packagePath = ""
        )
)
